...
public class TestBretagne_COL_ExcelSheet {
...
// Popup dsur la page d'accueil
      ...
      // ************** Mes réceptions du réseau ***************
        ...
        String[] SR_R4C2 = {
                ...
                "Mes manquements Opérateurs Commerciaux"
        };
        ...
        String[] SR_R2C3 = {
                "Mes comités de pilotage",
                "Mes comités de suivi",
                "Mes comités Suivi DSP",
                "Mes ateliers GT SI",
                "Mes ateliers GT process et RI",
                "Mes ateliers GT Exploitation",
                "Mes ateliers GT extensions",
                "Mes ateliers GT Communication",
                "Mes ateliers GT Nouveau Process"
        };
        ...
        try (FileOutputStream fileOut = new FileOutputStream("Recette_Bretagne_COL.xlsx")) {
    ...
    static void addDataToExcel(Sheet sheet, int rowNum, String categorie, String rubrique, String sousRubrique, String statut) {
