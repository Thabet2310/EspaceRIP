...
public class TestBretagne_OCC_ExcelSheet {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        Sheet sheet = workbook.createSheet("Bretagne_OCC");
      ...
      //  ******* Mes offres et contarts usagers ******
        ...
        String R3C2 = "Mes réceptions du réseau";
        String[] SR_R3C2 = {
                "Mes PV réception",
                "Mes retours"
        };
        ...
        try (FileOutputStream fileOut = new FileOutputStream("Recette_Bretagne_OCC.xlsx")) {
