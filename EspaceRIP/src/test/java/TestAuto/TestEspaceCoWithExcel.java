...
public class TestEspaceCoWithExcel {
    @Test
    ...
    public static void main(String[] args) throws InterruptedException, FileNotFoundException {
        ...
        for (String rubrique : rubriques) {
            ...
            if (elementExiste(driver, By.xpath(pathMenuTitle))) {
                ...
                String[] sousRubriques = {"Mon contrat Public", "Mes contrats tiers"}; //,"Ma sécurité chantiers", "Mes factures"
                ...
                for (String sousRubrique : sousRubriques) {
                    ...
                    if (sousRubriqueExiste) {
                        ...
                        // Liste des éléments
                        String[] elements = {"Mon contrat public signé", "Mes DC4", "Mes CSPS", "Mes contrats sous-traitance Orange SA"};
                        ...
                        for (String element : elements) {
                            ...
                            if (elementExiste) {
                                ...
                                System.out.println("L element : " + element + " , la sous rubrique  " + sousRubrique);
