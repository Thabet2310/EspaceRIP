...
public class TestSAONE_OSA_ExcelSheet {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        //Acceder à la catégorie Mon contrat Public
...
// Accéder à la rubrique Mon reporting
        ...
        try (FileOutputStream fileOut = new FileOutputStream("Recette_SAONE_OSA.xlsx")) {
