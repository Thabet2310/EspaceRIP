...
public class TestSAONE_DEMO_ExcelSheet {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        Sheet sheet = workbook.createSheet("SAONE_DEMO");
        ...
        String[] SR_R2C1 = { "Mes offres de référence",};
        ...
        try (FileOutputStream fileOut = new FileOutputStream("Recette_SAONE_DEMO.xlsx")) {
