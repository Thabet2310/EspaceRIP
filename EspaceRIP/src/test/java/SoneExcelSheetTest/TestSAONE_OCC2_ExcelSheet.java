...
public class TestSAONE_OCC2_ExcelSheet {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        Sheet sheet = workbook.createSheet("SAONE_OCC2");
      ...
      //  ******* Mes offres & contarts usagers ******
        ...
        try (FileOutputStream fileOut = new FileOutputStream("Recette_SAONE_OCC2.xlsx")) {
