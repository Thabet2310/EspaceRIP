...
public class GERS_OCC2 {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        String NomProfilUtilisateur = "GERS_OCC2";
        ...
        String[] R1C1 = {"Mon contrat Public", "Mes contrats tiers", "Mes offres & contrats usagers", "Ma communication", "Ma gouvernance"}; // Rubriques de catégorie 1
        String[][] SR_R1C1 = {
                ...
                // Sous-rubriques de rubrique 5 de catégorie 1
                {"Mon dossier de consultation", "Mes Business Reviews", "Mes Steerco"}

        };

        // Catégorie : Mon réseau
        String C2 = "Mon réseau"; // Categorie
        String[] R2C2 = {"Mes documents de référence", "Ma sécurité chantiers", "Mon déploiement", "Ma vie de réseau", "Mes finances"}; // Rubriques de catégorie 2
        String[][] SR_R2C2 = {
                ...
                // Sous-rubriques de rubrique 5 de catégorie 2
                {"Mon financement", "Ma trésorerie", "Mes comptes", "Ma fiscalité", "Mes rapports de gestion"}
