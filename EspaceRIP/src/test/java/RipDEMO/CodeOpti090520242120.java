...
public class CodeOpti090520242120 {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        String[][] SR_R1C1 = {{"Mon contrat public signé", "Mon acte de transfert"}, // Sous-rubriques de rubrique 1 de catégorie 1
                {"Mes contrats sous-traitance Orange SA", "Mes contrats autres fournisseurs"}}; // Sous-rubriques de rubrique 2 de catégorie 1
        ...
        String[][] SR_R2C2 = {{"Mes CSPS", "Mes PGC"}, // Sous-rubriques de rubrique 1 de catégorie 2
                {"Mes processus", "Mes matériels"}}; // Sous-rubriques de rubrique 2 de catégorie 2

        // Catégorie : Mon pilotage
        String C3 = "Mon pilotage"; // Categorie
        String[] R3C3 = {"Mes factures", "Mes réunions"}; // Rubriques de catégorie 3
        String[][] SR_R3C3 = {{"Mes demandes de subvention", "Mes redevances et contributions"}, // Sous-rubriques de rubrique 1 de catégorie 3
                {"Mes comités de suivi", "Mes ateliers"}}; // Sous-rubriques de rubrique 2 de catégorie 3
